    ...
    override fun onDonePressed(currentFragment: Fragment?) {
        ...
        if (APIHelper.isNetworkAvailable(this)) {
            ...
            if (firstTimeInitLogin.input1 != null && firstTimeInitLogin.input2 != null) {
                ...
                if (isMAL)
                    AuthenticationCheckTask(this, this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, username, password)
                else
                    AuthenticationCheckTask(this, this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, username)
            } else {
                dialog!!.dismiss()
